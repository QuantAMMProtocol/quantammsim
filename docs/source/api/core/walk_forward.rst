...
Registry-based lookup for extracting and aggregating per-cycle metrics.
Supports prefix-based aggregation (``mean_``, ``worst_``) and negation
(``neg_``) for use as Optuna objectives.
