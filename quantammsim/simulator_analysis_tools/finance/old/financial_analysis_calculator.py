...
def perform_financial_analysis(portfolio_returns, hodl_returns, btc_returns, dailyRfValues):
    ...
    btc_information_ratio = faf.calculate_tracking_error_and_information_ratio(portfolio_returns, btc_returns)
    ...
    risk_metrics_btc_rb = faf.calculate_portfolio_risk_metrics(portfolio_returns, dailyRfValues, btc_returns)
    ...
    btc_alpha = faf.calculate_jensens_alpha(portfolio_returns, dailyRfValues, btc_returns)
